...
def filter_df(cur_pitcher, cur_level, pickoff_totals):
...
def main():
    ...
    ppo2 = pd.read_csv("C://Users//lwstr//OneDrive//Documents//GitHub//smt2024umn//Dashboard//ppo2_db.csv")
    ...
    file_path = "C:\\Users\\lwstr\\OneDrive\\Documents\\GitHub\\smt2024umn\\pickoff_second_tendency.csv"
