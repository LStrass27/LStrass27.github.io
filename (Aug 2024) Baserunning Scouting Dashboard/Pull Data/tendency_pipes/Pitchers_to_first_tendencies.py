...
def main():
    conn = sqlite3.connect(':memory:')
    # Parameters
    player_dataframe = pd.read_csv("C://Users//lwstr//OneDrive//Documents//GitHub/smt2024umn/Dashboard/pitcher_catcher_db_pitcher_miss.csv")

    ppo1 = pd.read_csv("C://Users//lwstr//OneDrive//Documents//GitHub/smt2024umn/Dashboard/ppo1_db.csv")
    ppo1['level'] = ppo1['game_str'].str.split('_').str[3]

    ppo1.to_sql('ppo1', conn, index=False, if_exists='replace')
    ...
    file_path = "C://Users//lwstr//OneDrive//Documents//GitHub//smt2024umn//Pull Data//pitcher_pickoff_1st_lead_tendency.csv"
    ...
    for i, row in player_dataframe.iterrows():
        ...
        player_level = "Home" + player_level
