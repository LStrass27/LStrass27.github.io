...
def main():
    ...
    del2 = pd.read_csv("C://Users//lwstr//OneDrive//Documents//GitHub//smt2024umn//Dashboard//sb2_db.csv")
    del2['level'] = del2['game_str'].str.split('_').str[3]

    resultlist = []

    # Initialize final CSV if it doesn't exist
    file_path = "C:\\Users\\lwstr\\OneDrive\\Documents\\GitHub\\smt2024umn\\deliverytime2.csv"
    ...
    del2['deliverytime'] = resultlist
    
    # Write DataFrame to a CSV file
    del2.to_csv(file_path, index=False)

    del2 = del2[del2['deliverytime'] < 1200]

    del2.to_sql('del2', conn, index=False, if_exists='replace')
